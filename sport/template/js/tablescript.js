...
render: function() {
  ...
  this.$el.html('<td  style="background: white;">' + this.model.get('id') + '</td><td style="background: white;"><a href="' + this.model.get('url') + '">' + this.model.get('sport') + '</a>' + '</td><td style="background: white;">' + this.model.get('date') + '</td><td style="background: white;">' + this.model.get('place') + '</td>');
